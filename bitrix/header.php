...
//         let IblockSectionIDFieldTesting123=document.querySelector('[data-cid="IBLOCK_SECTION"]');
//         if(IblockSectionIDFieldTesting123){
//             console.log(IblockSectionIDFieldTesting123);
//             // IblockSectionIDFieldTesting123.style.pointerEvents="none";
//         }

        

//         // let satestoDivVarieblebistvis=document.querySelectorAll('[id="uiToolbarContainer"]');


//         //     satestoDivVarieblebistvis.forEach(element => {
//         //         // console.log(element);
//         //     });     
